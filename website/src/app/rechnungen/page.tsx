  ...
  return (
    <div className="flex bg-[#f4f3ef]">
        <div className="sidebar flex flex-col h-[100vh] overflow-hidden" style={{ background: 'linear-gradient(#66615b,#000 80%)' }}>
            ...
            <a href="/kunden" className='flex items-center gap-[12px] pt-[20px] pb-[20px] cursor-pointer text-[rgba(255,255,255,0.6)] hover:text-[rgba(255,255,255,1)] transition-colors duration-300 ease-in-out'>
            ...
            <a href="/rechnungen" className='flex items-center gap-[12px] pt-[20px] pb-[20px] cursor-pointer text-[#00a2a2] transition-colors duration-300 ease-in-out'>
        ...
        <div className="flex flex-col h-[100vh] content">
          <div className="flex items-center border-b border-gray-300 w-full h-[63px] pl-[31px] pr-[31px]">
            ...
            <h1 className='text-[rgba(0,0,0,1)]'>Rechnungen</h1>
